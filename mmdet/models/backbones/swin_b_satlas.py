...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(
            ...
            downsample_layer: Callable[..., nn.Module] = None,
    ):
        super().__init__()
        _log_api_usage_once(self)
...
class SwinTransformerV2Satlas(nn.Module):
    def __init__(self, num_channels, pretrained):
        super().__init__()
        ...
        self.backbone.features[0][0] = torch.nn.Conv2d(num_channels, self.backbone.features[0][0].out_channels,
...
if __name__ == '__main__':
    ...
    model = SwinTransformerV2Satlas(num_channels=3, pretrained=None)
    y = model(x)
