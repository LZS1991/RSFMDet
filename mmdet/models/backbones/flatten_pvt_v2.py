...
class FlattenPyramidVisionTransformerV2(BaseModule):
    def __init__(self, img_size=224, in_chans=3, embed_dims=[64, 128, 256, 512],
                 num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4], qkv_bias=False, qk_scale=None, drop_rate=0.,
                 attn_drop_rate=0., drop_path_rate=0., norm_layer=nn.LayerNorm,
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1], la_sr_ratios='8421', num_stages=4, linear=False,
                 focusing_factor=3, kernel_size=5, attn_type='LLLL', out_indices=(0, 1, 2, 3),
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            for m in self.modules():
                ...
                elif isinstance(m, OverlapPatchEmbed):
                    m.init_weights()
        else:
...
if __name__ == '__main__':
    ...
    model = FlattenPyramidVisionTransformerV2(
        img_size=448, patch_size=4, embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
