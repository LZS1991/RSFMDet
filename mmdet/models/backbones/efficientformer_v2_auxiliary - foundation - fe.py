...
class EfficientFormerV2Auxiliary(nn.Module):
    ...
    def __init__(self,
        ...
        self.auxiliary_net = FLFAuxiliaryFramework(img_size=self.img_size,
    ...
    def forward(self, x):
        ...
        for idx, block in enumerate(self.network):
            if idx == 0:
                # Begin Step 2.1 fuse feature from mobilenet
                # End Step 2.1 fuse feature from mobilenet
                index += 1
            ...
            if isinstance(block, Embedding):
                ...
                vit_feature = vit_features[index-1]
                vit_b_adapter = getattr(self.auxiliary_net, "vit_b_adapter_{}".format(index-1))
                vit_b_fusion = getattr(self.auxiliary_net, "vit_b_fusion_{}".format(index-1))
...
if __name__ == '__main__':
    ...
    model = EfficientFormerV2Auxiliary(
        layers=[2, 2, 6, 4],
        ...
        # init_cfg=None,
        init_cfg=dict(
            checkpoint='E:/08-PythonProject/20221214 EfficientViT/EfficientViTMMDetection/models/hub/checkpoints/eformer_s0_450.pth'),
