...
class EfficientViT(torch.nn.Module):
    def __init__(self, img_size=224,
                 ...
                 distillation=False, pretrained=None):
        super().__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        if pretrained is None:
            ...
            assert 'checkpoint Only support ' \
            ...
            _static_dict_D = self.state_dict()
            for k in _state_dict.keys():
                if _static_dict_D[k].shape != _state_dict[k].shape:
                    _state_dict[k] = _state_dict[k][:, :, None, None]
