...
class PyramidVisionTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        for i, num_layer in enumerate(num_layers):
            embed_dims_i = embed_dims * num_heads[i]
            source_embed_dims.append(embed_dims_i)
...
@BACKBONES.register_module()
class PyramidVisionTransformerV2Auxiliary(PyramidVisionTransformer):
    """Implementation of `PVTv2: Improved Baselines with Pyramid Vision
    Transformer <https://arxiv.org/pdf/2106.13797.pdf>`_."""

    def __init__(self, **kwargs):
        super(PyramidVisionTransformerV2Auxiliary, self).__init__(
            patch_sizes=[7, 3, 3, 3],
            paddings=[3, 1, 1, 1],
...
if __name__ == '__main__':
    ...
    model = PyramidVisionTransformerV2Auxiliary(
        in_channels=3,
        img_size=224,
        out_indices=(0, 1, 2, 3),
        # init_cfg=None,
        init_cfg=dict(
            checkpoint='E:/08-PythonProject/20221214 EfficientViT/EfficientViTMMDetection/models/hub/checkpoints/pvt_v2_b0.pth'),
