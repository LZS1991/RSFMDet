...
class RepViT(BaseModule):
    def __init__(self, cfgs, distillation=False, init_cfg=None, out_indices=(0, 1, 2, 3)):
        super(RepViT, self).__init__(init_cfg=init_cfg)
...
if __name__ == "__main__":
    ...
    model = RepViT(cfgs, out_indices=(2, 6, 22, 25))
    y = model(x)
    print(y)
