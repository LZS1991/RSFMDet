...
from mmcv.cnn import (constant_init, normal_init, trunc_normal_init, build_norm_layer)
...
class InCeptionNext(nn.Module):
    ...
    def __init__(
        ...
        for i in out_indices:
            layer = build_norm_layer(dict(type='LN'), dims[i])[1]
            layer_name = f'norm{i}'
...
if __name__ == '__main__':
    ...
    model = InCeptionNext(depths=(3, 3, 9, 3), dims=(96, 192, 384, 768), token_mixers=InceptionDWConv2d, )
    y = model(x)
    print(y)
...
#     model = InCeptionNext(depths=(3, 3, 9, 3), dims=(96, 192, 384, 768),
#                           token_mixers=InceptionDWConv2d,
#                           **kwargs
#                           )
...
#     model = InCeptionNext(depths=(3, 3, 27, 3), dims=(96, 192, 384, 768),
#                           token_mixers=InceptionDWConv2d,
#                           **kwargs
#                           )
...
#     model = InCeptionNext(depths=(3, 3, 27, 3), dims=(128, 256, 512, 1024),
#                           token_mixers=InceptionDWConv2d,
#                           **kwargs
#                           )
