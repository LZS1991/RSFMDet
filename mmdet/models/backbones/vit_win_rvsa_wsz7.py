...
class RotatedVariedSizeWindowAttention(nn.Module):
    def __init__(self, dim, num_heads, out_dim=None, window_size=1, qkv_bias=True, qk_scale=None, attn_drop=0.,
                 proj_drop=0, attn_head_dim=None, relative_pos_embedding=True, learnable=True, restart_regression=True,
...
class ViT_Win_RVSA_V3_WSZ7(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, depth=12,
                 ...
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=None, init_values=None, use_checkpoint=True,
                 use_abs_pos_emb=False, use_rel_pos_bias=False, out_indices=[2, 5, 8, 11], interval=3, pretrained=None,
...
if __name__ == '__main__':
    ...
    # 与预训练模型匹配的参数为：
    model = ViT_Win_RVSA_V3_WSZ7(
        img_size=224, patch_size=16, in_chans=3, embed_dim=768, depth=12,
        num_heads=12, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
        drop_path_rate=0.15, hybrid_backbone=None, norm_layer=None, init_values=None, use_checkpoint=True,
        use_abs_pos_emb=True, use_rel_pos_bias=False, out_indices=[2, 5, 8, 11], interval=3,
        pretrained='E:/08-PythonProject/20221214 EfficientViT/EfficientViTMMDetection/models/hub/checkpoints/vit-b-win-rvsa_v3_wsz7_fpn_1x_dota10_ms_lr1e-4_ldr75_dpr15-backbone.pth',
        restart_regression=True
    )
