...
class lite_vision_transformer(nn.Module):
    ...
    def __init__(self, layers, in_chans=3, 
                #  num_classes=1000, 
                 patch_size=4,
                 ...
                 drop_path_rate=0., norm_layer=nn.LayerNorm, init_cfg=None):
...
class LiteViT(lite_vision_transformer):
    def __init__(self, rasa_cfg=None, init_cfg=None):
        super().__init__(
            layers=[2,2,2,2],
            patch_size=4,
