...
if __name__ == "__main__":
    ...
    for i in range(len(model_config_dir)):
        ...
        # config_file = './tools_{}/work_dirs/{}_auxiliary_all/{}_auxiliary.py'.format(dataset_name, model_config_name, model_config_name)  # 模型配置文件路径
        config_file = './tools_{}/work_dirs/{}_auxiliary_all_swin/{}_auxiliary.py'.format(dataset_name, model_config_name, model_config_name)  # 模型配置文件路径
