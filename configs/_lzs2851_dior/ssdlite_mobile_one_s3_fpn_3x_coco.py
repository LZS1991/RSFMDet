...
model = dict(
    ...
    backbone=dict(
        ...
        use_se=False,
        init_cfg=dict(
            type='Pretrained', checkpoint='../models/hub/checkpoints/mobileone_s3_unfused.pth.tar',
            prefix='backbone.')),
    neck=dict(
        type='SSDNeck',
        in_channels=(768, 2048),
        out_channels=(768, 2048, 512, 256, 256, 128),
    ...
    bbox_head=dict(
        type='SSDHead',
        in_channels=(768, 2048, 512, 256, 256, 128),
        num_classes=20,
        use_depthwise=True,
        norm_cfg=dict(type='BN', eps=0.001, momentum=0.03),
        act_cfg=dict(type='ReLU6'),
